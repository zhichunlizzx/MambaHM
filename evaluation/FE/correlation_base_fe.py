...
def corr_resolution(predicted_file, experiment_file, path_peak, length=0, window_size=128,
    ...
    """
    # open the bigwig file use pyBigWig
    ...
    for chr in peaks:
        ...
        for peak in chr_peaks:
            ...
            # convert peak to specified length
            if length != 0:
                mid = (start + end) // 2
...
def main():
    ...
    path_peak = 'MambaHM/genome_regions/FunctionalElements/GM12878/promoter.bed'
    path_bigwig_predicted = 'predicted.bw'
    path_bigwig_exper = 'exper.bw'
    pearson, spearman = corr_resolution(
                                    path_bigwig_predicted,
                                    path_bigwig_exper,
                                    path_peak,
